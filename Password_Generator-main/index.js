...
// function to generate generate Symbol
...
function showAlert(strength) {
    alertContainer.innerHTML = `
        <div class="alert alert-${strength} alert-dismissible fade show" role="alert">
            <strong>PASSWORD STRENGTH - ${strength.charAt(0).toUpperCase() + strength.slice(1)}</strong>
